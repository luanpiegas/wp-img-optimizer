...
class ImageOptimizerAdvanced
{
    ...
    public function enqueue_admin_scripts($hook)
    {
        if ($hook === 'settings_page_image-optimizer') {
            ...
            // Inline CSS for the settings page UI polish
...
.imgopt-progress-wrap { margin-top: 16px; }
...
CSS;
            wp_add_inline_style('image-optimizer-admin', $css);
        }
    }
...
?>
        <div class="wrap">
            ...
            <div class="imgopt-stats-grid">
                ...
                <div class="imgopt-stat">
                    <div class="imgopt-stat-value"><?php echo esc_html($this->format_bytes($stats['bytes_saved'])); ?></div>
            ...
            <div class="card">
                ...
                <div id="optimization-progress" style="display:none; margin-top: 15px;">
                    ...
                    <input type="hidden" id="progress-bar-processed" value="0">
                    <input type="hidden" id="progress-bar-total" value="100">
                    <p id="current-file"></p>
                </div>
            </div>
                    ...
                    $('#optimize-existing').click(function() {
                        ...
                        $.post(imgOptimizer.ajax_url, {
                            ...
                            if (response.success && response.data.total > 0) {
                                ...
                                $('#progress-bar-total').val(totalImages);
